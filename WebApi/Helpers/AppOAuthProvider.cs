...
namespace WebApi.Helpers
{
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            ApplicationDbContext xx = new ApplicationDbContext();
            var UserManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(xx));
            var currentUser = await UserManager.FindAsync(usernameVal, passwordVal);
